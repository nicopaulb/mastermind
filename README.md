...
Find the followings items : 
- `src` : Embedded code for the board
- `dts` : Project specific Zephyr bindings
- `boards`: Zephyr devicetree overlays for the nRF microcontrollers
